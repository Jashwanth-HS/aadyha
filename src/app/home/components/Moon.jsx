...
export default function Moon() {
  return (
    <div className={styles.MoonContainer}>
      <div className={styles.MoonHeading}><h1>to moon</h1></div>
      ...
      <p className={styles.MoonDescription}>
        <span className="heading-3">Inspiring humanity's quests for exploration</span>
      ...
      <div className={styles.ChandrayaanContainer}>
        <svg xmlns="http://www.w3.org/2000/svg" width="99" height="75" viewBox="0 0 99 75" fill="none">
          <circle cx="4.53576" cy="37.2585" r="2" transform="rotate(-23.6877 4.53576 37.2585)" fill="#D9D9D9"/>
          <rect opacity="0.3" x="2.37988" y="35.2529" width="95" height="3.99204" rx="1.99602" transform="rotate(0.116142 2.37988 35.2529)" fill="url(#paint0_linear_1329_13359)"/>
          <defs>
            <linearGradient id="paint0_linear_1329_13359" x1="3.37988" y1="39.245" x2="72.3799" y2="39.245" gradientUnits="userSpaceOnUse">
