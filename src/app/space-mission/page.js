...
const Banner = () => {
    ...
    <div>
        <h6 className="micro-large secondary-font">Mission critical solutions</h6>
        <h1 className="heading-1">Space mission</h1>
        <p className="paragraph">Embark on a journey beyond Earth's boundaries as we pioneer the next era of space exploration.</p>
    </div>
    <div>
      <picture>
        <source media="(min-width: 768px)" srcset={"/assets/images/space-mission-banner.png"}/> 
        <source media="(max-width: 767px)" srcset={"/assets/images/space-mission-banner-mobile.png"}/>
        <img src="/assets/images/space-mission-banner.png" alt="Fallback Image" />
      </picture>
    </div>
  </div>
  }
